...
p <- p+theme(axis.text=element_text(size=8.00),axis.title=element_text(size=11,face="plain"),plot.title=element_text(size=10,face='plain'))
p <- p+theme(strip.text = element_text(size = 9.0))
p <- p
p <- p+xlab('Substrate quality')+ylab('No. of regulated conditions')
p <- p + theme(legend.position = "none")

ggsave(file='Supp_fig_8.pdf', plot=p, width=6.5, height=4.25)
