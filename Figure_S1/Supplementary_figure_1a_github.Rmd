...
col2 <- c(rep('D',length(D_scores)),rep('E',length(D_scores)))
...
p <- p + ylab("log-odds of the binomial probability") + xlab("Position") + ggtitle('CK2 substrates')
...
p <- p+theme(axis.text=element_text(size=9),axis.title.x=element_text(size=9,face="plain",vjust=4.5,margin = margin(t = 0, r = 0, b = 0, l = 0)),
             axis.title.y=element_text(size=9,face="plain"),plot.title=element_text(size=10,face='bold'))
