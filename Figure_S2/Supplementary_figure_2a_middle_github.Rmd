---
title: "Supplementary figure 2a (middle)"
...
p <- ggplot(mss_data, aes(x=Positions, y=Stoichiometry)) + geom_boxplot(fill='white',color=colors()[190], lwd=1.25, notch=FALSE,fatten=0.75, width=0.6, outlier.shape=NA) + geom_jitter(width = 0.2, color=colors()[35],size=0.6) #colors()[123]
...
ggsave(file='Supplementary_figure_2A_Wu.pdf', plot=b2, width=6.0, height=4.8)
