...
p <- ggplot(mss_data, aes(x=Positions, y=Stoichiometry)) + geom_boxplot(color=colors()[220],lwd=1.2, width=0.5) + geom_boxplot(fill='white',color=colors()[190], lwd=1.2, notch=FALSE,fatten=1.5,width=0.5,aes(ymin=..lower.., ymax=..upper..))
...
p <- p+theme(axis.text.x=element_text(size=5),axis.text.y=element_text(size=9),axis.title.x=element_text(size=8,face="plain"),axis.title.y=element_text(size=9,face="plain"),plot.title=element_text(size=18,face='bold'))
